...
class FeedbacksControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create feedback" do
    assert_difference('Feedback.count') do
      post feedbacks_url, params: { feedback: { Optional_Name: @feedback.Optional_Name, caption: @feedback.caption } }
    end
  ...
  test "should update feedback" do
    patch feedback_url(@feedback), params: { feedback: { Optional_Name: @feedback.Optional_Name, caption: @feedback.caption } }
